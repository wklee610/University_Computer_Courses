...
Y_train = sio.loadmat(r'C:\Users\Andy\Desktop\csc4008\hw1\ATNT face\trainY.mat')
X_train = sio.loadmat(r'C:\Users\Andy\Desktop\csc4008\hw1\ATNT face\trainX.mat')
Y_test = sio.loadmat(r'C:\Users\Andy\Desktop\csc4008\hw1\ATNT face\testY.mat')
X_test = sio.loadmat(r'C:\Users\Andy\Desktop\csc4008\hw1\ATNT face\testX.mat')
...
def classification(centroid_array, y_train, x_testt, y_test):
    for row2 in range(40):                  ###对每个centroid data进行遍历
        sum = 0
        for col in range(644):
...
predictions = []
for row1 in range(80):                      ###对每个test data 进行遍历
    dist_list = []
...
correct_rate = (correct_count/80)*100
error_rate = (error_count/80)*100
