...
#define EVAL_FILE std::string{__FILE__}
#define EVAL_LINE std::to_string(__LINE__)
#define EVAL_FUNC std::string{__PRETTY_FUNCTION__}
#define _UNIMPLEMENTED \
    (std::string{" umimplemented"} + " " + EVAL_FUNC + " (" + EVAL_FILE + ":" + EVAL_LINE + ")")
#define UNIMPLEMENTED \
    EXPECT_NO_ERROR(throw ErrorException(_UNIMPLEMENTED));
 ...
 */
#define PROVIDED_TEST(name, ID) /* For our use. */
